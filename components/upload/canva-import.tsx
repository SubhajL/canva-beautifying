...
export function CanvaImport({ onImport, disabled }: CanvaImportProps) {
  ...
  const [importMode, setImportMode] = useState<"auto" | "api" | "manual">(
    "auto"
  )
  const { toast } = useToast()
  const { addToHistory, hasImportedDesign } = useCanvaHistory()
  const { steps, currentStep, updateStep, nextStep, setError, reset } =
    useImportProgress()
  const {
    isConnected,
  ...
  const handleImport = async (mode: "api" | "manual" | "auto" = importMode) => {
    ...
    try {
      ...
      if (
        data.alternativeAction === "manual_upload_required" ||
        data.method === "manual"
      ) {
        updateStep("download", {
          status: "error",
        ...
        toast({
          ...
          description:
            "Please download the file from Canva and upload it manually",
          action: (
      ...
      const errorMessage =
        error instanceof Error ? error.message : "Failed to import from Canva"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          >
            ...
            <TabsContent value="auto" className="mt-4 space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Automatically choose the best method. Will use API if
                  connected, otherwise manual.
                </AlertDescription>
              </Alert>
              <Button
              ...
              {apiEnabled ? (
                <>
                  <Alert>
                    ...
                    <AlertDescription>
                      Direct API integration for seamless imports. Requires
                  ...
                  {isConnected ? (
                    <div className="space-y-3">
                      ...
                      <Button
                        ...
                        disabled={
                          loading || disabled || !url || !!validationError
                        }
                        className="w-full"
                      >
                        {loading ? (
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    API integration is not configured. Please use manual import
                    or contact support.
                  </AlertDescription>
                </Alert>
              )}
            ...
            <TabsContent value="manual" className="mt-4 space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Download from Canva manually and upload the file. Works with
                  all designs.
                </AlertDescription>
              </Alert>
              <Button
          ...
          <Alert>
            ...
            <AlertDescription>
              Make sure your Canva design is set to &quot;Anyone with the link
              can view&quot; for successful import.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="ml-8 text-sm text-muted-foreground">
              Click the &quot;Share&quot; button in the top right corner of your
              design.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="ml-8 text-sm text-muted-foreground">
              Click &quot;Copy link&quot; and paste it in the import field
              above.
            </p>
          </div>
          ...
          <Alert className="mt-4">
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              <strong>Note:</strong> We&apos;ll download the highest quality
              version available from your Canva design. For best results, ensure
              your design is complete and saved before importing.
            </AlertDescription>
          </Alert>
