        ...
        const betaFeatures: Feature[] = [
          {
            ...
            description:
              "Use multiple AI models simultaneously for enhanced results",
            icon: Brain,
            status: "active",
          ...
          },
          {
            ...
            description:
              "Enhance multiple documents at once with smart queuing",
            icon: FileStack,
            status: "active",
          ...
          },
          {
            ...
            name: "Magic Enhance",
            description:
              "One-click enhancement with AI-powered style detection",
            icon: Wand2,
            status: "active",
