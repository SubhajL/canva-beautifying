...
const steps = [
  {
    ...
    icon: Sparkles,
    content:
      "You're among the first to experience BeautifyAI's powerful document enhancement features.",
  },
  {
    id: "benefits",
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    I agree to provide feedback and allow BeautifyAI to collect
                    usage feedback to improve the product.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    I agree to share anonymous usage data to help improve the
                    product experience.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    I&apos;d like to receive updates about new features and beta
                    program news.
                  </p>
                </div>
              </div>
            ...
            <Card className="border-muted bg-muted/50">
              <CardContent className="p-4">
                <p className="text-xs text-muted-foreground">
                  By joining the beta program, you acknowledge that you&apos;re
                  using pre-release software that may contain bugs. Your data is
                  secure and will be handled according to our privacy policy.
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <Button
              ...
              disabled={
                ...
                (currentStep === steps.length - 1 &&
                  (!consents.feedback || !consents.analytics))
              }
            >
              {isCompleting ? (
                "Completing..."
