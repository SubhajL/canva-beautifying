  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed bottom-4 right-4 z-50 h-14 w-14 rounded-full p-0 shadow-lg"
        variant="default"
      >
      ...
      {/* Support Panel */}
      {isOpen && (
        <div className="fixed bottom-20 right-4 z-50 flex h-[600px] w-96 flex-col rounded-lg border bg-background shadow-2xl">
          {/* Header */}
          ...
          >
            <TabsList className="mx-4 mt-2 grid w-full grid-cols-3 p-1">
            ...
            {/* New Ticket Tab */}
            <TabsContent value="new" className="flex-1 space-y-4 p-4">
              <div>
              ...
              <Button
                ...
                disabled={
                  loading || !newTicket.subject || !newTicket.description
                }
                className="w-full"
              >
                Create Ticket
            ...
            {/* Chat Tab */}
            <TabsContent value="chat" className="flex flex-1 flex-col p-4">
              {selectedTicket ? (
                <>
