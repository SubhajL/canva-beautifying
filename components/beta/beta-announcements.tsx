...
const announcements: Announcement[] = [
  {
    ...
    description:
      "You can now enhance multiple documents at once! Upload up to 10 files and process them simultaneously.",
  ...
  },
  {
    ...
    description:
      "Resolved the bug causing exports to fail for documents with special characters in filenames.",
  ...
  },
  {
    ...
    description:
      "Updated our AI models for 30% faster processing and better quality enhancements.",
  ...
  },
  {
    ...
    description:
      "We'll be performing maintenance on Saturday, 2 AM - 4 AM EST. Service may be intermittent.",
  ...
  },
  {
    ...
    description:
      "Beta testers can now create and save custom enhancement style templates.",
          ...
          <div className="space-y-4">
            {announcements.map((announcement) => {
              ...
              return (
                ...
                >
                  <div className={`h-fit rounded-lg p-2 ${bgColor}`}>
