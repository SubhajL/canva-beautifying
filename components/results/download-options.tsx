  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem
          onClick={() =>
            downloadFile(enhancedUrl, getEnhancedFilename(), "enhanced")
          }
        ...
        >
          <div className="flex w-full items-center justify-between">
            ...
            {downloading === "enhanced" && <Loading size="xs" inline />}
          </div>
        </DropdownMenuItem>

        <DropdownMenuItem
          onClick={() =>
            downloadFile(originalUrl, getOriginalFilename(), "original")
          }
          disabled={downloading !== null}
        >
          <div className="flex w-full items-center justify-between">
            ...
            {downloading === "original" && <Loading size="xs" inline />}
          </div>
        </DropdownMenuItem>
        ...
        {reportUrl && (
          <DropdownMenuItem
            onClick={() =>
              downloadFile(reportUrl, `${documentName}_report.pdf`, "report")
            }
            disabled={downloading !== null}
          >
            <div className="flex w-full items-center justify-between">
              ...
              {downloading === "report" && <Loading size="xs" inline />}
            </div>
          </DropdownMenuItem>
        )}
        ...
        <DropdownMenuItem onClick={downloadAll} disabled={downloading !== null}>
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center">
              <Package className="mr-2 h-4 w-4" />
              <span>Download All</span>
            </div>
            {downloading === "all" && <Loading size="xs" inline />}
          </div>
        </DropdownMenuItem>
