        ...
        <div className="space-y-6">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    {isActive && stageProgress > 0 && (
                      <Progress value={stageProgress} className="mt-2 h-1" />
                    )}
                  </div>
                </div>
              )
          ...
          <div className="flex justify-center py-4">
            <div className="relative">
              <div className="h-16 w-16 animate-pulse rounded-full border-4 border-primary/20" />
          ...
          <div className="text-center text-sm text-muted-foreground">
            <p>
              This usually takes 2-5 minutes depending on document complexity.
            </p>
            <p className="mt-1">
              Feel free to leave this page - we&apos;ll email you when it&apos;s
              ready!
            </p>
          </div>
        </div>
