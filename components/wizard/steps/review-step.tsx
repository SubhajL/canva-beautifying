...
export function ReviewStep() {
  ...
  const { data, setStep, updateData, setProcessing, removeFile } =
    useWizardStore()
  ...
  const handleStartEnhancement = async () => {
    ...
    try {
      ...
      if (hasMultipleFiles) {
        ...
        formData.append(
          "settings",
          JSON.stringify({ enhancementSettings: preferences })
        )
    ...
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-muted-foreground">
          Confirm your choices before we enhance your{" "}
          {hasMultipleFiles ? "documents" : "document"}
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            ...
            <Button variant="ghost" size="sm" onClick={() => setStep("model")}>
              <Edit className="mr-1 h-3 w-3" />
              Edit
            </Button>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <Badge variant="default">
                {getModelLabel(data.selectedModel)}
              </Badge>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {getAudienceLabel(data.targetAudience)}
                </Badge>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Grade:</span>
                <Badge variant="secondary">
                  {getGradeLabel(data.gradeLevel)}
                </Badge>
              </div>
              {data.subject && (
                <div className="flex items-center justify-between">
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {getStyleLabel(data.enhancementStyle)}
                </Badge>
              </div>
              <div className="flex items-center justify-between">
