...
function Badge({ className, variant, ...props }: BadgeProps) {
  const { densityClass } = require('@/lib/ui/density') as typeof import('@/lib/ui/density')
  return (
    <div className={cn(badgeVariants({ variant }), densityClass('px-2','px-2.5'), className)} {...props} />
  )
}
