      ...
      >
        {thumbnail && (
          <div className="relative h-48 w-full overflow-hidden bg-gray-100">
            ...
            />
            {improvementScore && (
              <div className="absolute right-2 top-2 flex items-center gap-1 rounded-full bg-black/70 px-3 py-1 text-sm text-white">
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            ...
            <Badge className={cn("ml-2", statusColors[status])}>{status}</Badge>
          </div>
        </CardHeader>
