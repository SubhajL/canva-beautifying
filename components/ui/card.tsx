...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-1.5", densityClass("p-4","p-6"), className)}
    {...props}
  />
))
...
const CardContent = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn(densityClass("p-4 pt-0","p-6 pt-0"), className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center", densityClass("p-4 pt-0","p-6 pt-0"), className)}
    {...props}
  />
))
