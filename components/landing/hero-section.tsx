...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50 pb-20 pt-32">
      <div className="bg-grid-slate-100 absolute inset-0 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.5))]" />
      ...
      <div className="container relative mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-10 text-xl text-gray-600 sm:text-2xl">
            Upload your educational materials and watch as our AI enhances them
            to be more engaging, professional, and age-appropriate. Perfect for
            teachers, educators, and content creators.
          </p>
            ...
            <div className="rounded-lg bg-white p-8 shadow-2xl">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex aspect-[4/3] items-center justify-center rounded-lg bg-gradient-to-br from-primary/20 to-secondary/20">
