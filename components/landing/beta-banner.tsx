        ...
        <div className="flex flex-col items-center justify-center gap-4 text-center sm:flex-row sm:text-left">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">
              Limited Time: Join Our Exclusive Beta Program!
            </span>
          </div>
          <Link
            href="/beta-program"
            className="inline-flex items-center gap-2 text-sm font-medium underline-offset-4 transition-all hover:gap-3 hover:underline"
          >
