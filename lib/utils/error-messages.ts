  ...
  switch (errorCode) {
    case ErrorTypes.VALIDATION_ERROR:
      return {
        ...
        actions: [{ label: "Review Input", action: "review" }],
        recoverable: true,
      }
    ...
    case ErrorTypes.AUTHENTICATION_ERROR:
      return {
        ...
        actions: [{ label: "Sign In", action: "signin" }],
        recoverable: true,
      }
    ...
    case ErrorTypes.RATE_LIMIT:
      return {
        ...
        actions: [{ label: "Wait", action: "wait" }],
        recoverable: true,
      }
    ...
    case ErrorTypes.EXTERNAL_SERVICE_ERROR:
      return {
        ...
        message:
          "One of our services is experiencing issues. Please try again later.",
        actions: [
          { label: "Retry", action: "retry" },
