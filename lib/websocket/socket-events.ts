...
export interface ServerToClientEvents {
  ...
  "enhancement:failed": (data: { documentId: string; error: string }) => void
  ...
  "optimistic:confirm": (data: { updateId: string }) => void

  "optimistic:reject": (data: { updateId: string; reason?: string }) => void
