...
export class ComparisonGenerator {
  ...
  private calculateImprovements(
    ...
    const metrics: ImprovementMetrics = {
      overallImprovement: calculateGain(
        before.overallScore,
        after.overallScore
      ),
      ...
      typographyImprovement: calculateGain(
        before.typographyScore,
        after.typographyScore
      ),
      percentageGains: {
        overall: calculatePercentage(before.overallScore, after.overallScore),
        visualAppeal: calculatePercentage(
          before.visualAppeal,
          after.visualAppeal
        ),
  ...
  generateComparisonVisual(
    ...
    const categories = [
      ...
      {
        name: "Visual Appeal",
        before: before.visualAppeal,
        after: after.visualAppeal,
      },
      {
        name: "Readability",
      ...
      {
        name: "Engagement",
        before: before.engagement,
        after: after.engagement,
      },
      {
        name: "Color Harmony",
        before: before.colorHarmony,
        after: after.colorHarmony,
      },
      { name: "Layout", before: before.layoutScore, after: after.layoutScore },
      {
        name: "Typography",
        before: before.typographyScore,
        after: after.typographyScore,
      },
    ]
