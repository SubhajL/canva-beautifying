...
export class ResourceTracker {
  ...
  private async getLinuxDiskIO(): Promise<DiskIOMetrics> {
    ...
    if (this.previousDiskStats) {
      ...
      const deltaReadBytes =
        current.readBytes - this.previousDiskStats.readBytes
      const deltaWriteBytes =
        current.writeBytes - this.previousDiskStats.writeBytes
      const deltaReadTime = current.readTime - this.previousDiskStats.readTime
      const deltaWriteTime =
        current.writeTime - this.previousDiskStats.writeTime
