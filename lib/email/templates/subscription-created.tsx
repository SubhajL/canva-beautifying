...
export const SubscriptionCreatedEmail: React.FC<
  ...
  return (
    ...
    >
      <Section style={content}>
        <Heading style={heading}>Welcome to BeautifyAI {planName}! 🎉</Heading>

        <Text style={paragraph}>Hi {userName},</Text>

        <Text style={paragraph}>
          Thank you for subscribing to BeautifyAI {planName}! Your subscription
          is now active and you&apos;re ready to take your document enhancement
          to the next level.
        </Text>
        ...
        <Text style={paragraph}>
          ...
          or reply to this email. As a {planName} subscriber, you get priority
          support!
        </Text>

        <Text style={paragraph}>
          You can manage your subscription anytime from your{" "}
          <Link href="https://beautifyai.com/account/subscription" style={link}>
            account settings
          </Link>
          .
        </Text>
        ...
        <Text style={signOff}>
          Thanks for choosing BeautifyAI!
          <br />
          The BeautifyAI Team
        </Text>
      </Section>
