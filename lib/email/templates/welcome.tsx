  ...
  return (
    ...
    >
      <Section style={content}>
        <Heading style={heading}>Welcome to BeautifyAI! 🎨</Heading>

        <Text style={paragraph}>Hi {userName},</Text>

        <Text style={paragraph}>
          Welcome aboard! We&apos;re thrilled to have you join the BeautifyAI
          community. You&apos;re all set to start transforming your documents
        ...
        <Section style={stepsSection}>
          ...
          <Row style={stepRow}>
            ...
            <Column style={stepContent}>
              ...
              <Text style={stepDescription}>
                Drag and drop or click to upload your worksheet, presentation,
          ...
          <Row style={stepRow}>
            ...
            <Column style={stepContent}>
              ...
              <Text style={stepDescription}>
                Our AI analyzes your document and automatically enhances layout,
          ...
          <Row style={stepRow}>
            ...
            <Column style={stepContent}>
              ...
              <Text style={stepDescription}>
                Download your enhanced document in your preferred format and use
                it anywhere.
              </Text>
            </Column>
          </Row>
        ...
        <Section style={resourcesSection}>
          ...
          <Text style={paragraph}>
            •{" "}
            <Link
              href="https://beautifyai.com/docs/getting-started"
              style={link}
            >
            ...
            <br />•{" "}
            <Link
              href="https://beautifyai.com/docs/best-practices"
              style={link}
            >
              Best Practices for Document Enhancement
            </Link>
            <br />•{" "}
            <Link href="https://beautifyai.com/templates" style={link}>
        ...
        <Text style={paragraph}>
          ...
          <Link href="https://beautifyai.com/help" style={link}>
            Help Center
          </Link>
          .
        </Text>
