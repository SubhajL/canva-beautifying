...
export class ABTestManager {
  ...
  private static initializeDefaultTests(): void {
    ...
    this.addTest({
      ...
      description:
        "Test if aggressive cost optimization improves retention for basic tier users",
      startDate: new Date(),
      targetAudience: {
        userTiers: ["basic"],
        userPercentage: 50,
    ...
    this.addTest({
      ...
      description:
        "Test if always selecting highest quality models improves premium user satisfaction",
      startDate: new Date(),
      targetAudience: {
        userTiers: ["premium"],
        userPercentage: 30,
