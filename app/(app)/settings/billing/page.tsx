...
export default function BillingPage() {
  ...
  const currentTierDetails =
    SUBSCRIPTION_TIERS[
      currentTier.toUpperCase() as keyof typeof SUBSCRIPTION_TIERS
    ]
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="font-medium">
                {userDetails?.usage_count || 0} /{" "}
                {currentTierDetails.features.monthlyCredits}
              </p>
            </div>
          </CardContent>
        ...
        <div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {Object.values(SUBSCRIPTION_TIERS).map((tier) => (
              <Card
                key={tier.id}
                className={currentTier === tier.id ? "border-primary" : ""}
              >
                <CardHeader>
