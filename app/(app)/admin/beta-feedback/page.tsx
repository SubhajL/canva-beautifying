...
export default function BetaFeedbackManagement() {
  ...
  const [selectedFeedback, setSelectedFeedback] = useState<BetaFeedback | null>(
    null
  )
            ...
            <>
              <DialogHeader>
                <DialogTitle className="flex items-center gap-2">
                  {React.createElement(
                    typeIcons[selectedFeedback.feedback_type],
                    {
                      className: "h-5 w-5",
                    }
                  )}
              ...
              <div className="my-4 space-y-4">
                <div className="flex gap-2">
                  ...
                  <Badge
                    className={priorityColors[selectedFeedback.priority]}
                    variant="secondary"
                  >
