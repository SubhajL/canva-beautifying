    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-0 right-1/4 h-[400px] w-[400px] translate-x-1/2 translate-y-1/2 rounded-full bg-purple-500/10 blur-3xl" />
        </div>
        ...
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            ...
            revolutionary AI-powered document enhancement. Help shape the future
            of visual content while enjoying premium features for free.
          </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Be part of an exclusive group shaping the future of document
              enhancement
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Get exclusive access to cutting-edge AI features before anyone
                  else. Be the first to experience the future of document
                  enhancement.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Your feedback directly influences our development. Have a real
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                As a beta tester, you&apos;ll receive access to features
                typically reserved for our highest tier subscribers.
              </p>
            ...
            <div className="relative">
              <Card className="relative overflow-hidden">
                ...
                <CardHeader className="relative">
                  <Badge className="mb-4 w-fit">BETA EXCLUSIVE</Badge>
                ...
                <CardContent className="relative space-y-6">
                  <div>
                    <p className="mb-2 text-sm font-medium">AI Models</p>
                  ...
                  <div>
                    <p className="mb-2 text-sm font-medium">Monthly Limits</p>
                    <p className="text-2xl font-bold">Unlimited</p>
                  </div>
                  <div>
                    <p className="mb-2 text-sm font-medium">Support</p>
                    <p className="text-muted-foreground">
                      Priority + Direct Team Access
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            {[
              {
                ...
                content:
                  "The AI suggestions transformed our presentations completely. Can't wait for the full launch!",
                rating: 5,
              },
              {
                ...
                role: "Teacher",
                content:
                  "This tool saves me hours on creating engaging worksheets. My students love the enhanced visuals.",
                rating: 5,
              },
              {
                name: "Emma Thompson",
                ...
                content:
                  "Game-changer for our pitch decks. The AI understands design principles better than most designers.",
                rating: 5,
              },
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Roll out advanced AI models and batch processing",
                  status: "upcoming",
                },
                {
                  date: "March 2024",
                  ...
                  description:
                    "Implement top requested features from beta testers",
                  status: "upcoming",
                },
                {
                  date: "April 2024",
                  title: "Public Launch",
                  description:
                    "Full platform launch with beta tester benefits locked in",
                  status: "upcoming",
                },
              ].map((item, index) => (
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <Accordion type="single" collapsible className="mt-12">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                Beta testers get full access to all premium features including
                unlimited enhancements, all AI models, priority processing, and
                direct support. You&apos;ll also receive a lifetime 50% discount
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                The beta program runs for 3 months from January to April 2024.
                After that, you&apos;ll automatically transition to a discounted
                premium plan with all your beta benefits preserved.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Yes, invitation codes are being distributed to ensure quality
                feedback. You can request one by joining our waitlist, or if you
                have a code from our team or another beta tester, you can use it
                to join immediately.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                We ask that you actively use the platform and provide feedback
                through our built-in feedback system. Monthly surveys are
                optional but appreciated. There&apos;s no minimum usage
                requirement - use it as much or as little as fits your needs.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-5">
              <AccordionTrigger>
                Will my data be safe during the beta?
              </AccordionTrigger>
              <AccordionContent>
                Absolutely. We use enterprise-grade encryption and security
                measures. Your documents are stored securely on Cloudflare R2
                and are only accessible by you. We never train our AI models on
                user data.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-6">
              <AccordionTrigger>
                Can I invite others to the beta program?
              </AccordionTrigger>
              <AccordionContent>
                Yes! Each beta tester receives 3 invitation codes to share with
                colleagues or friends. This helps us build a diverse testing
                community while keeping the program exclusive.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Don&apos;t have a code? You&apos;ll be added to our
                    waitlist.
                  </p>
                </div>
